...
public class Examenfkc {
    ...
    public int [][] transformado27(int xy, int num){
...
//                    System.out.println("["+x+"]["+y+"] = "+ num++ +"\t");
     ...
     public static void main(String[] args) {
               ...
               while (opcion!=0) {            
               switch(opcion){
               case 1: or.imprimir(or.transformada08(din, ini)) ; break;
               case 2: or.imprimir(or.transformada24(din, ini));break;
               case 3: or.imprimir(or.transformada25(din, ini)); break;
               case 4: or.imprimir(or.transformado27(din, ini)); break;
               case 5: or.imprimir(or.transformado35(din, ini)); break;
